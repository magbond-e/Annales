...
export function BottomNavCTA() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 md:hidden animate-in fade-in slide-in-from-bottom-3 duration-300">
      <Link
        href="/deposer"
        className="flex items-center gap-2.5 px-5 py-3.5 bg-gradient-to-r from-brand to-teal-700 text-white font-bold rounded-full shadow-xl shadow-brand/30 hover:scale-105 active:scale-95 transition-all text-xs tracking-wide"
      >
